...
const MATRIX: Record<string, Partial<Record<Module, AccessLevel>>> = {
  ...
  'Social Media Specialist':   { sprints: 'view', plan: 'none', library: 'view', studio: 'none', calendar: 'full', tracker: 'full', budget: 'none', brand: 'none', catalog: 'none', settings: 'none', tasks: 'full', notifications: 'full', insights: 'full' },
