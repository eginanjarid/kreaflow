...
const MATRIX: Record<string, Partial<Record<Module, AccessLevel>>> = {
  ...
  'Social Media Specialist':   { sprints: 'full', plan: 'full', library: 'full', studio: 'full', calendar: 'full', tracker: 'full', budget: 'none', brand: 'none', catalog: 'none', settings: 'none', tasks: 'full', notifications: 'full', insights: 'full' },
